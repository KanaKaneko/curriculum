...
public class ExException {
    ...
    public static void main(String[] args) {
        ...
        do {
        	/*do...while文(無限ループ)
        	 * while内が正しい時doの中が繰り返される*/

            System.out.println(CONST_COMMON_INIT_INFO);
            sc = new Scanner(System.in);
            /*Scanner scanner = new Scanner(System.in);
             * ❶上の形にならないのはなぜ？-変数定義されているから
             * キーボードから入力された値を取得する。scannerクラス
            ...
            try {
                 ...
                 * Intとついているから「整数」を取り込む。Doubleがついたら「少数点」
                 */

                // 早期処理戻し
                if (execute == -1) break;
                /*❷{break;}みたいにかっこしなくていいのか
                 * →今回のは処理を行うとかではなくただ単にbreakを実行しているだけだから。
                 * executeが-1の時ループから抜ける*/
                // オペレーションエラー
                if (execute != 1) {
                ...
                switch (parameter) {
                    ...
                    */
                    ...
                    // ここへ記述
                    /*throwを使用しないから①みたいに下に書かずここに書いてる*/
                    break;
                    ...
                    break;
                    default:
                    /* default ラベルを使用すると、式を評価した値がいずれのラベルとも一致しない場合のラベルとして使用することができます。*/
